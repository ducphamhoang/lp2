...
const FeaturedOffer = () => {
  ...
  return (
    <section className="py-16 bg-white track-view" data-tracking-id="pricing-section-viewed">
          ...
          <div className="order-1 lg:order-2">
            ...
            <div className="space-y-4 mb-8">
              ...
              <div className="flex items-start space-x-3">
                ...
                <p className="text-gray-700 font-paragraph">Quà tặng & khuyến mãi hiện có: Tặng váy cưới trị giá 15 triệu; Đặt sớm nhận tiền mặt 3–7 triệu; Bốc thăm trúng xe điện; Giảm 1 triệu cho menu trong tuần. Liên hệ để biết điều kiện áp dụng.</p>
              </div>
            </div>
